...
const TransactionModelSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'source': PropertySchema(
      ...
      name: r'source',
      type: IsarType.byte,
      enumMap: _TransactionModelsourceEnumValueMap,
    ),
...
void _transactionModelSerialize(
  ...
  writer.writeString(offsets[7], object.rawSmsBody);
...
TransactionModel _transactionModelDeserialize(
  ...
  object.isarId = id;
  object.place = reader.readString(offsets[6]);
  object.rawSmsBody = reader.readString(offsets[7]);
  object.source =
      _TransactionModelsourceValueEnumMap[reader.readByteOrNull(offsets[8])] ??
...
P _transactionModelDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 7:
      return (reader.readString(offset)) as P;
    case 8:
      return (_TransactionModelsourceValueEnumMap[
              reader.readByteOrNull(offset)] ??
          TransactionSource.sms) as P;
    case 9:
      return (reader.readDateTime(offset)) as P;
    default:
...
const _TransactionModelsourceEnumValueMap = {
  'sms': 0,
  'manual': 1,
};
const _TransactionModelsourceValueEnumMap = {
  0: TransactionSource.sms,
  1: TransactionSource.manual,
};
...
extension TransactionModelQuerySortBy
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterSortBy> sortByPlace() {
    return QueryBuilder.apply(this, (query) {
...
extension TransactionModelQuerySortThenBy
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterSortBy> thenByPlace() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'place', Sort.asc);
    });
  }
...
extension TransactionModelQueryWhereDistinct
  ...
  QueryBuilder<TransactionModel, TransactionModel, QDistinct> distinctByCardId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TransactionModel, TransactionModel, QDistinct> distinctByPlace(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension TransactionModelQueryProperty
  ...
  QueryBuilder<TransactionModel, String, QQueryOperations> cardIdProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TransactionModel, String, QQueryOperations> placeProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TransactionModel, TransactionSource, QQueryOperations>
      sourceProperty() {
    return QueryBuilder.apply(this, (query) {
